...
print("cost = " .. cost)
print("tostring(cost) = " .. tostring(cost))
print("TEMPLE_PERK_REROLL_COUNT = " .. perk_reroll_count)
...
local real_cost = ComponentGetValue(itemcost_comp, "cost")
print("reroll cost: " .. real_cost)
